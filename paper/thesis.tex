...
%% Load packages.
%%
\usepackage[interimsci]{otagothesis}     %% Use Otago page layout
...
\usepackage{pgfplots}
\usepackage{setspace}
\newcommand{\ThesisName}{Form segmentation and reorganisation English, Bangla using Tesseract OCR Engine.}
%%
%% Set title, author and date.
%%
\title{\ThesisName}
\author{Tanvir Hasan\\Reg No: 12101005\\Anup Kumar Kar\\Reg No: 12101033\\Sayem Hossain\\Reg No: 12101046}
\date{\today}
